...
/*
	📌 Evento Change: Nos permite detectar cuando hay un cambio en el valor de un input, select o textarea.
...
/*
	📌 Evento Focus: Nos permite detectar cuando un input recibe el foco de atención.
*/
...
/*
	📌 Evento Blur: Nos permite detectar cuando un input pierde el foco de atención.
*/
...
/*
	📌 Evento keyup: Se ejecuta cuando un una tecla es levantada al escribir sobre un input.
*/
formulario.correo.addEventListener('keydown', (e) => {
	// El evento nos devuelve que tecla fue presionada
	console.log(e);
