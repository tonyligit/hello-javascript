...
/*
	📌 getElementsByTagName: Nos permite obtener una colección de elementos en base a la etiqueta.
	Nota: Devuelve una colección HTML. Una colección no es un Array.
*/
...
/*
	📌 getElementsByClassName: Nos permite obtener una colección de elementos en base a su clase CSS.
...
/*
	📌 querySelectorAll: Nos da una colección de elementos en base a un selector estilo CSS.
	Nota: Devuelve un nodelist. 
*/
